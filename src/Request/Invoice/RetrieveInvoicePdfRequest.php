...
/**
 * Class RetrieveInvoicePdfRequest
 *
 * @package Nascom\TeamleaderApiClient\Request\Invoice
 */
class RetrieveInvoicePdfRequest extends AbstractPostRequest
{
    /**
     * RetrieveInvoicePdfRequest constructor.
     *
     * @param $invoice_id
     * @param array $options
     */
